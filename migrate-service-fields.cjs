...
const client = new Client({
  connectionString: 'postgresql://railway:eajKeAQopjDrchwqYfNYZkcuolwryQTi@roundhouse.proxy.rlwy.net:26971/railway',
...
async function migrate() {
  ...
  `)
  console.log('Added service_name, description, category columns')
  ...
  `)
  console.log('Updated Tanya Nursery endpoint')
  ...
  `)
  console.log('Set defaults for remaining endpoints')
